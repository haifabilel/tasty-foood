...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `order` (food, price, qty, order_date, status, customer_name, customer_contact, customer_email, customer_address) VALUES (
    ...
    if ($query->execute()) {
        // Message à afficher dans la fenêtre modale
        $message = "Merci d'avoir passé une commande chez tasty";
