...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `order_food` (food, price, qty, order_date, status, customer_name, customer_contact, customer_email, customer_address) VALUES (
                ...
                <fieldset>
                   ...
                   if (isset($_GET['id'])) {
                    ...
                    <div class="food-menu-desc">
                        <h3><?=$user['titre']?></h3>
                        <input type="text" name="food" value="<?php $user['titre']; ?>">
